...
defaults = {
    ...
    "roadmap_data": None,
    "last_audio_id": None,
    "current_answer_text": None,   # transcribed answer for the CURRENT question, or None if not answered yet
...
with tab_interview:
    ...
    if st.session_state.questions:
        ...
        if idx < total:
            ...
            # If we haven't got feedback yet for this question, show the recorder
                ...
                if audio and audio["id"] != st.session_state.last_audio_id:
                    ...
                    with st.spinner("Transcribing your answer..."):
                        with tempfile.NamedTemporaryFile(suffix=".wav", delete=False) as tmp:
                            ...
                            tmp_path = tmp.name
                        try:
                            answer_text = ai_engine.transcribe_audio(tmp_path)
                        finally:
                            os.unlink(tmp_path)
